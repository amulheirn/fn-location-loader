...
If the lat/long are not provided, the script will look up the address in OpenStreetmap and geocode it to a lat/long.  Then it will create the location with those coordinates in Forward's API.
